---
title: "Syllabus, CMPSC 9, Winter 2025"
layout: handout
ready: true
---
...
* **Course Web Site**: <https://ucsb-cs9.github.io/w25/>
* **Instructor**:  [Richert Wang](http://www.cs.ucsb.edu/~richert)
   * Email is richert@ucsb.edu, BUT please use [Piazza](https://piazza.com/ucsb/winter2025/cmpsc9) for course related communication.
* **Lecture**: Tu Th 11am-12:15pm (BRDA 1610)
* **TAs**:  {{site.ta_list_full}} (contact via Piazza)
* **Mentors**: {{site.mentors_list}} (contact via Piazza)
* **Lab** (50 minute lab sections): Wednesdays 11am (GIRV 1116), 12pm (SH 1430), 1pm (GIRV 1119), 2pm (GIRV 1119), 3pm (GIRV 1119), 4pm (GIRV 1119), 5pm (NH 1109), 6pm (NH 1109)
* **Office Hours**: See <https://ucsb-cs9.github.io/w25/info/office_hours/>
...
|-----------------------------------------------|---------------------------|
| Academic Integrity Contract (Tuesday 1/14)    | 1 %                      |
| Midterm (Thursday 2/6), 11am - 12:15pm        | 35 %                      |
| Final (Wed 3/19), 12pm - 2pm                  | 35 %                      |
| Homeworks                                     | 9 %                      |
| Labs                                          | 20 %                      |
